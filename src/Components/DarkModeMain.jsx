...
if(!props.countries.length) {
    return (
        <div className='main px-20 py-10'>
            ...
            <input
            className='bg-[#2b3945] w-4/12 py-2 pl-16 pr-2 shadow-[0_0_8px_1px_rgba(0,0,0,0.1)]'
            type="text"
            placeholder='Search for a country...'
            onChange={handleChange}
            />
            <img className='absolute w-5 top-1/4 left-8' src={searchIcon} alt="" />
            <select className='bg-[#2b3945] w-2/12 py-2 px-5 shadow-[0_0_8px_1px_rgba(0,0,0,0.1)] float-right' name="" id="" onChange={handleFilterChange}>
